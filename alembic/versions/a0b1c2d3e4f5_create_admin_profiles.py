"""Create admin_profiles table and backfill existing hospital admins.
...
def upgrade() -> None:
    ...
    if "admin_profiles" not in inspector.get_table_names():
        op.create_table(
            "admin_profiles",
        ...
        op.create_index(
            op.f("ix_admin_profiles_id"),
            "admin_profiles",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_admin_profiles_user_id"),
            "admin_profiles",
            ["user_id"],
            unique=False,
        )
