"""OPD Billing professional profile (1:1 with users)."""
...
class OpdBillingProfile(Base):
    __tablename__ = "opd_billing_profiles"
    ...
    user = relationship("User", back_populates="opd_billing_profile")
