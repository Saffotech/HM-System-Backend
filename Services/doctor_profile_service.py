...
DOCTOR_ROLE = "doctor"
DOCTOR_UPLOAD_DIR = os.getenv("DOCTOR_PROFILE_UPLOAD_DIR", "uploads/doctor_image")
...
def upload_profile_image(
    ...
    delete_profile_image_file(DOCTOR_UPLOAD_DIR, old_stored_path)
